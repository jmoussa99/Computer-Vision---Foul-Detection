...
def main() -> int:
    ...
    parser.add_argument("--visualize", action="store_true", help="Save overlay videos for each sampled clip.")
    ...
    extractor = ClipFeatureExtractor(FeatureConfig(max_frames=args.max_frames, frame_stride=args.frame_stride, resize_width=args.resize_width))
